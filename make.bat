...
rem songidx inhalt-eigene.sxd inhalt-eigene.sbx
...
rem move Eigene_Mappe.pdf out
move Eigene_Mappe_2.pdf out
move Eigene_Mappe_3.pdf out
del -f *.aux *.log
